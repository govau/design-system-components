...
When making a new component, we would be very greatful if you post the research, design decisions, use cases for the component, accessibility considerations to the [community forum](https://community.digital.gov.au/c/designsystem) before submitting a pull request. This may be in the form of a code snippet, screenshots, sketch files or written text on some of the research you have done. This gives a chance for members of the community to respond and share any previous work they may have done in the past on a similar component.
