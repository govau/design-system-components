...
describe('AuBodyDirective', () => {
    ...
    it("should use dark css class for dark template", fakeAsync(() => {
        ...
        expect(fixture.nativeElement.querySelector("div").classList[0]).toBe("au-body");
        expect(fixture.nativeElement.querySelector("div").classList[1]).toBe("au-body--dark");
    }));

    it("setting dark body value should set the right css class", fakeAsync(() => {
    ...
    it("should be able to override UiKitCoreService color palette CSS class by setting empty value", fakeAsync(() => {
