...
describe("AuFocusDirective", () => {
  ...
  it("should use dark css class for dark template", fakeAsync(() => {
    ...
    expect(fixture.nativeElement.querySelector("div").classList[0]).toBe("au-focus");
    expect(fixture.nativeElement.querySelector("div").classList[1]).toBe("dark");
  }));

  it("setting dark outline value should set the right css class", fakeAsync(() => {
