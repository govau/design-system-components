...
For more details have a look at the [usage example](https://github.com/govau/design-system-components/tree/master/components/keyword-list/tests/react/index.js).
...
The visual test: https://auds.service.gov.au/components/keyword-list/tests/site/
