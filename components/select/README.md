...
For more details have a look at the [usage example](https://github.com/govau/design-system-components/tree/master/components/select/tests/react/index.js).
...
The visual test: https://auds.service.gov.au/components/select/tests/site/
